...
const (
	...
	MessageType_MessageType_SimplechainGetAddress       MessageType = 56
	MessageType_MessageType_SimplechainAddress          MessageType = 57
	MessageType_MessageType_SimplechainSignTx           MessageType = 58
	MessageType_MessageType_SimplechainTxRequest        MessageType = 59
	MessageType_MessageType_SimplechainTxAck            MessageType = 60
	...
	MessageType_MessageType_SimplechainSignMessage      MessageType = 64
	MessageType_MessageType_SimplechainVerifyMessage    MessageType = 65
	MessageType_MessageType_SimplechainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_SimplechainGetAddress",
	57:  "MessageType_SimplechainAddress",
	58:  "MessageType_SimplechainSignTx",
	59:  "MessageType_SimplechainTxRequest",
	60:  "MessageType_SimplechainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_SimplechainSignMessage",
	65:  "MessageType_SimplechainVerifyMessage",
	66:  "MessageType_SimplechainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_SimplechainGetAddress":       56,
	"MessageType_SimplechainAddress":          57,
	"MessageType_SimplechainSignTx":           58,
	"MessageType_SimplechainTxRequest":        59,
	"MessageType_SimplechainTxAck":            60,
	"MessageType_GetECDHSessionKey":           61,
	"MessageType_ECDHSessionKey":              62,
	"MessageType_SetU2FCounter":               63,
	"MessageType_SimplechainSignMessage":      64,
	"MessageType_SimplechainVerifyMessage":    65,
	"MessageType_SimplechainMessageSignature": 66,
...
// *
// Request: Ask device for Simplechain address corresponding to address_n path
// @next PassphraseRequest
// @next SimplechainAddress
// @next Failure
type SimplechainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *SimplechainGetAddress) Reset()                    { *m = SimplechainGetAddress{} }
func (m *SimplechainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*SimplechainGetAddress) ProtoMessage()               {}
func (*SimplechainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *SimplechainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SimplechainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Simplechain address derived from device private seed
// @prev SimplechainGetAddress
type SimplechainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SimplechainAddress) Reset()                    { *m = SimplechainAddress{} }
func (m *SimplechainAddress) String() string            { return proto.CompactTextString(m) }
func (*SimplechainAddress) ProtoMessage()               {}
func (*SimplechainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *SimplechainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next SimplechainTxRequest
// @next Failure
type SimplechainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *SimplechainSignTx) Reset()                    { *m = SimplechainSignTx{} }
func (m *SimplechainSignTx) String() string            { return proto.CompactTextString(m) }
func (*SimplechainSignTx) ProtoMessage()               {}
func (*SimplechainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *SimplechainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SimplechainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *SimplechainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *SimplechainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *SimplechainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *SimplechainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *SimplechainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *SimplechainSignTx) GetDataLength() uint32 {
...
func (m *SimplechainSignTx) GetChainId() uint32 {
...
// @prev SimplechainSignTx
// @next SimplechainTxAck
type SimplechainTxRequest struct {
...
func (m *SimplechainTxRequest) Reset()                    { *m = SimplechainTxRequest{} }
func (m *SimplechainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*SimplechainTxRequest) ProtoMessage()               {}
func (*SimplechainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *SimplechainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *SimplechainTxRequest) GetSignatureV() uint32 {
...
func (m *SimplechainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *SimplechainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev SimplechainTxRequest
// @next SimplechainTxRequest
type SimplechainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SimplechainTxAck) Reset()                    { *m = SimplechainTxAck{} }
func (m *SimplechainTxAck) String() string            { return proto.CompactTextString(m) }
func (*SimplechainTxAck) ProtoMessage()               {}
func (*SimplechainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *SimplechainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next SimplechainMessageSignature
// @next Failure
type SimplechainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *SimplechainSignMessage) Reset()                    { *m = SimplechainSignMessage{} }
func (m *SimplechainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*SimplechainSignMessage) ProtoMessage()               {}
func (*SimplechainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *SimplechainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SimplechainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type SimplechainVerifyMessage struct {
...
func (m *SimplechainVerifyMessage) Reset()                    { *m = SimplechainVerifyMessage{} }
func (m *SimplechainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*SimplechainVerifyMessage) ProtoMessage()               {}
func (*SimplechainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *SimplechainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *SimplechainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *SimplechainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev SimplechainSignMessage
type SimplechainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SimplechainMessageSignature) Reset()                    { *m = SimplechainMessageSignature{} }
func (m *SimplechainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*SimplechainMessageSignature) ProtoMessage()               {}
func (*SimplechainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *SimplechainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *SimplechainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SimplechainGetAddress)(nil), "SimplechainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*SimplechainAddress)(nil), "SimplechainAddress")
	...
	proto.RegisterType((*SimplechainSignTx)(nil), "SimplechainSignTx")
	proto.RegisterType((*SimplechainTxRequest)(nil), "SimplechainTxRequest")
	proto.RegisterType((*SimplechainTxAck)(nil), "SimplechainTxAck")
	proto.RegisterType((*SimplechainSignMessage)(nil), "SimplechainSignMessage")
	proto.RegisterType((*SimplechainVerifyMessage)(nil), "SimplechainVerifyMessage")
	proto.RegisterType((*SimplechainMessageSignature)(nil), "SimplechainMessageSignature")
