...
//
// Detailed usage document and tutorial available on the go-simplechain Wiki page:
// https://github.com/simplechain-org/go-simplechain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
