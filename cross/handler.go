...
type MsgHandler struct {
	...
	//availableMakerCh     chan core.NewCWssEvent
	//availableMakerSub    event.Subscription
...
func (this *MsgHandler) Start() {
	...
	//this.availableMakerCh = make(chan core.NewCWssEvent, txChanSize)
	//this.availableMakerSub = this.ctxStore.SubscribeNewCWssEvent(this.availableMakerCh)
