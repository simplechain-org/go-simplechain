...
import (
	...
	"github.com/simplechain-org/go-simplechain/swarm/multihash"
	"github.com/simplechain-org/go-simplechain/swarm/spancontext"
...
it is the public interface of the FileStore which is included in the simplechain stack
*/
type API struct {
