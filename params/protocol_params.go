...
var (
	...
	GenesisDifficulty      = big.NewInt(120000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(131072) // The ethash minimum that the difficulty may ever be.
