...
var (
	...
	FoundationAddress  common.Address = common.HexToAddress("0x992ec45ae0d2d2fcf97f4417cfd3f80505862fbc")
)
...
var (
	...
	// and accepted by the Simplechain core developers into the Ethash consensus.
	//
	...
	// and accepted by the Simplechain core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
