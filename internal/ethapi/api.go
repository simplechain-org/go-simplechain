...
//
// https://github.com/simplechain-org/go-simplechain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/simplechain-org/go-simplechain/wiki/Management-APIs#personal_ecRecover
...
// NewPublicTxPoolAPI creates a new tx pool service that gives information about the transaction pool.
func NewPublicCtxPoolAPI(b Backend) *PublicCtxPoolAPI {
	return &PublicCtxPoolAPI{b}
}
