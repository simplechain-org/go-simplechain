...
// ecrecover extracts the Simplechain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Simplechain address
...
// Simplechain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Simplechain address of the signing key
...
// Author implements consensus.Engine, returning the Simplechain address recovered
