...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/simplechain-org/go-simplechain/issues/17593). Whilst this
	...
	for i, tt := range tests {
		...
		chain, err := core.NewBlockChain(db, nil, &config, engine, vm.Config{}, common.Address{}, nil)
		if err != nil {
