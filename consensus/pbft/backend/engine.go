...
func (sb *backend) verifyHeader(chain consensus.ChainReader, header *types.Header, parents []*types.Header) error {
	...
	if header.MixDigest != types.PbftDigest {
...
func (sb *backend) Prepare(chain consensus.ChainReader, header *types.Header) error {
	...
	header.MixDigest = types.PbftDigest
...
func (sb *backend) Seal(chain consensus.ChainReader, block *types.Block, results chan<- *types.Block, stop <-chan struct{}) error {
	...
	block, err = sb.signBlock(parent, block)
	if err != nil {
		return err
	}
	...
	go func() {
		...
		sb.proposedBlockHash = block.PendingHash()
...
func (sb *backend) signBlock(parent *types.Header, block *types.Block) (*types.Block, error) {
	header := block.Header()
	// sign the hash
