...
// Whisper represents a dark communication interface through the Simplechain
...
// New creates a Whisper client ready to communicate through the Simplechain P2P network.
