...
# 1. install sipe for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for sipe
# 5. create sipe, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SIMPLECHAIN_SOCKET
...
!define GROUPNAME "Simplechain"
!define APPNAME "Sipe"
!define DESCRIPTION "Official Go implementation of the Simplechain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since sipe is installed global
