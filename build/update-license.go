...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/simplechain-org/go-simplechain/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-simplechain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-simplechain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-simplechain"
	}
	if startOfSentence {
		return "The go-simplechain library"
	}
	return "the go-simplechain library"
}
