...
import (
	...
	"github.com/simplechain-org/go-simplechain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Simplechain requests through
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Sipe JavaScript console!\n\n")
	c.jsre.Run(`
