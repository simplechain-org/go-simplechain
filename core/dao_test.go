...
//
//	proBc, _ := NewBlockChain(proDb, nil, &proConf, ethash.NewFaker(), vm.Config{}, common.Address{}, nil)
//	defer proBc.Stop()
//
...
//
//	conBc, _ := NewBlockChain(conDb, nil, &conConf, ethash.NewFaker(), vm.Config{}, common.Address{}, nil)
//	defer conBc.Stop()
//
...
//		db = rawdb.NewMemoryDatabase()
//		gspec.MustCommit(db)
//		bc, _ := NewBlockChain(db, nil, &conConf, ethash.NewFaker(), vm.Config{}, common.Address{}, nil)
//		defer bc.Stop()
//
...
//		db = rawdb.NewMemoryDatabase()
//		gspec.MustCommit(db)
//		bc, _ = NewBlockChain(db, nil, &proConf, ethash.NewFaker(), vm.Config{}, common.Address{}, nil)
//		defer bc.Stop()
//
