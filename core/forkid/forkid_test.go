...
//				{9069000, ID{Hash: checksumToBytes(0x523c0685), Next: 9069000}}, // First Istanbul and first Muir Glacier block
//				{9199999, ID{Hash: checksumToBytes(0x523c0685), Next: 9069000}}, // Last Istanbul and first Muir Glacier block
//				{9200000, ID{Hash: checksumToBytes(0x523c0685), Next: 9200000}},       // First Muir Glacier block
//				{10000000, ID{Hash: checksumToBytes(0x523c0685), Next: 9200000}},      // Future Muir Glacier block
//			},
//		},
//		// Ropsten test cases
//		{
...
//			[]testcase{
//				{0, ID{Hash: checksumToBytes(0x305fce07), Next: 10}},            // Unsynced, last Frontier, Homestead and first Tangerine block
//				{9, ID{Hash: checksumToBytes(0x305fce07), Next: 10}},            // Last Tangerine block
//				{10, ID{Hash: checksumToBytes(0x305fce07), Next: 1700000}},      // First Spurious block
//				{1699999, ID{Hash: checksumToBytes(0x305fce07), Next: 1700000}}, // Last Spurious block
//				{1700000, ID{Hash: checksumToBytes(0x305fce07), Next: 4230000}}, // First Byzantium block
//				{4229999, ID{Hash: checksumToBytes(0x305fce07), Next: 4230000}}, // Last Byzantium block
//				{4230000, ID{Hash: checksumToBytes(0x305fce07), Next: 4939394}}, // First Constantinople block
//				{4939393, ID{Hash: checksumToBytes(0x305fce07), Next: 4939394}}, // Last Constantinople block
...
//				{6485846, ID{Hash: checksumToBytes(0x305fce07), Next: 7117117}}, // First Istanbul block
//				{7117116, ID{Hash: checksumToBytes(0x305fce07), Next: 7117117}}, // Last Istanbul block
