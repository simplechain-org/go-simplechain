...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage simplechain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    sipe wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Simplechain presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	sipe wallet [options] /path/to/my/presale.wallet
...
between simplechain nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    sipe account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    sipe account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another simplechain instance,
