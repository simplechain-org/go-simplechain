...
// sipe is the official command-line client for Ethereum.
package main
...
var (
	...
	app = utils.NewApp(gitCommit, gitDate, "the go-simplechain command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2019 The go-simplechain Authors"
