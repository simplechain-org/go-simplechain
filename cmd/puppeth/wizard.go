...
type wizard struct {
	...
	services map[string][]string   // Simplechain services known to be running on servers
...
// converts it to an Simplechain address. If an empty line is entered, the default
// value is returned.
