...
import (
	...
	math2 "github.com/simplechain-org/go-simplechain/common/math"
...
// newAlethGenesisSpec converts a go-simplechain genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-simplechain and aleth
...
// newPyEthereumGenesisSpec converts a go-simplechain genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *core.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-simplechain and pyethereum
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
