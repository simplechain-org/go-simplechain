...
import (
	...
	"github.com/simplechain-org/go-simplechain/swarm"
	bzzapi "github.com/simplechain-org/go-simplechain/swarm/api"
	swarmmetrics "github.com/simplechain-org/go-simplechain/swarm/metrics"
	"github.com/simplechain-org/go-simplechain/swarm/tracing"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Simplechain API provider to use to settle SWAP payments",
...
var app = utils.NewApp(gitCommit, "Simplechain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-simplechain Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.simplechain/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.simplechain/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:             dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.simplechain/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.simplechain/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:             dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//register BZZ as node.Service in the simplechain node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the simplechain node
