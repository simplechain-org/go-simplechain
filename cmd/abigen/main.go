...
var (
	abiFlag = flag.String("abi", "", "Path to the Simplechain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Simplechain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Simplechain contract Solidity source to build and bind")
